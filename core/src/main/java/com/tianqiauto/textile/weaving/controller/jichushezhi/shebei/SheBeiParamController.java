...
import com.tianqiauto.textile.weaving.service.SheBeiParamService;
...
public class SheBeiParamController {
    ...
    public Result findAll(String gx_id, String jx_id, String cslb_id){
        ProcedureResult procedureResult = sheBeiParamService.findAll(gx_id, jx_id, cslb_id);
    ...
    public Result updSheBeiParam_Batch (String idStr, String sfbj, String sfzs, String sfjlqx, String dw,
        ...
        ProcedureResult result = sheBeiParamService.updSheBeiParam_Batch(idStr, sfbj, sfzs, sfjlqx, dw, cslb_id, ccsc, cczq);
        //fixme
