...
public class PCN031Thread extends AbstractAnalysis {
    ...
    protected void analysisPcn(PCN responsePcn) {
        ...
        ParamVo.addParam(sourceId,"当前班次",String.valueOf(BytesUtil.bytesToShort(data[2])));
