...
K.options = {
	...
	htmlTags : {
		...
		embed : ['id', 'class', 'src', 'width', 'height', 'type', 'loop', 'autostart', 'quality', '.width', '.height', 'align', 'allowscriptaccess','flashvars','allowfullscreen'],
...
function _mediaEmbed(attrs) {
	...
	_each(attrs, function(key, val) {
		if(key == 'src'){
			html += key + '="' + K.options.pluginsPath+'ckplayer/ckplayer.swf" allowfullscreen="true" ';
			html += 'flashvars="video='+val +'&autoplay=true&loop=true" ';
		}else{
			html += key + '="' + val + '" ';
		}
	});
